...
urlpatterns = [
    ...
    path('profile/delete/', user_view.delete, name='user-profile-delete'),
    ...
    path('password-reset-compelete/',auth_views.PasswordResetCompleteView.as_view(template_name='user/password_reset_complete.html'),name="password_reset_complete"),
